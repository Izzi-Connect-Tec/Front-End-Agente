import { useUserContext } from "../../Providers/components/AmazonContext";
import "../styles/client.css";
import ClientHistory from "./ClientHistory";
import { ComputeAge } from "../logic/ComputeAge";
import { useLogInContext } from "../../Providers/components/LogInContext";
      ...
      <div className="completeClient">
        <div className="dataClient">
          ...
          <div className="client">
            <p className="labelNombre">{`${user.Nombre} ${user.ApellidoP} ${user.ApellidoM}`}</p>
  ...
  return (
    <div className="client">
      ...
      <div className="client-div">
        <div className="solucionTarjetaProblema"></div>
        {user.Nombre && (
          <div>
            {!reportView ? (
              <ClientDataFounded />
