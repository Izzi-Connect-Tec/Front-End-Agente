...
import {rejectCall, resumeCall, holdCall, acceptCall, hangUpCall, unmuteAgent, muteAgent, clearCall} from "../logic/CallButtons.js";
import Mute from "./Mute.jsx";
import { React, useEffect, useState } from "react";
import ExternOptions from "./ExternOptions.jsx";
    ...
    <section>
      <motion.div animate={animate} variants={variants}>
        <Stack
          ...
          className={IncomingCall ? "incoming-content" : null}
        >
          <DemoPaper>
            {incomingCall ? (
              <IncomingCall />
